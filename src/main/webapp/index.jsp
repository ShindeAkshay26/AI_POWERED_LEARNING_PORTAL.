			...
			<div class="col-md-6 mb-4">
				<div class="card h-60">
					<img src=<%=rs.getString("image")%> class="card-img-top"
						height="300px" width="80px" alt=<%=rs.getString("course_name")%>>
					<div class="card-body">
						<h5 class="card-title"><%=rs.getString("course_name")%></h5>
						<p class="card-text"><%=rs.getString("description")%></p>
						<a
							href="./learningpage.jsp?id=<%=rs.getInt("first_topic_id")%>&courseid=<%=rs.getString("course_id")%>&coursename=<%=rs.getString("course_name")%>"
							class="btn btn-primary stretched-link">Explore Course</a>
