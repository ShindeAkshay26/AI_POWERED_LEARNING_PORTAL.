...
<body>
	...
	<input type="hidden" id="coursetopicedit"
		value=<%=session.getAttribute("coursetopicedit")%>>
	<input type="hidden" id="deletecoursetopic"
		value=<%=session.getAttribute("deletecoursetopic")%>>
	<input type="hidden" id="addtopic"
		value=<%=session.getAttribute("addtopic")%>>
		...
		<ul class="list-group col-9 mb-3 border border-3">
			<li
				...
				<div class="ms-2 me-auto">
					...
					href="./editcourse.jsp?courseid=<%=rs.getString("course_id")%>"><button
							type="submit" class="btn btn-lg btn-info">Open</button></a></span>
			</li>
		</ul>
	...
	<script>
		...
		if (coursetopicedit == "success") {
			swal("Congratulations!", "Course topic updated successfully",
					"success");
		...
		if (deletecoursetopic == "success") {
			swal("Congratulations!", "Course topic deleted successfully",
					"success");
		...
		if (addtopic == "success") {
			swal("Congratulations!", "Course topic added successfully",
					"success");
